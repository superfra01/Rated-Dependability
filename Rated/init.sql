...
('gestore@catalogo.it', NULL, 'GestoreCatalogo', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'GESTORE', 0, 'Gestore Del Catalogo'),
('moderatore@forum.it', NULL, 'Moderatore', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'MODERATORE', 0, 'Moderatore'),
('alice.rossi@example.com', NULL, 'AliceRossi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Recensore appassionato di libri e film.'),
('marco.bianchi@example.com', NULL, 'MarcoBianchi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Recensore esperto di tecnologia e innovazione.'),
('luca.verdi@example.com', NULL, 'LucaVerdi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Critico di prodotti multimediali.'),
('chiara.neri@example.com', NULL, 'ChiaraNeri', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Specializzata in recensioni di narrativa.'),
('giulia.ferri@example.com', NULL, 'GiuliaFerri', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Recensore attivo nel settore della moda e del design.'),
('andrea.fontana@example.com', NULL, 'AndreaFontana', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Appassionato di viaggi e cultura.'),
('elena.marchi@example.com', NULL, 'ElenaMarchi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 3, 'Recensore cucina.'),
('federico.ruggeri@example.com', NULL, 'FedericoRuggeri', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Esperto elettronica.'),
('simona.costa@example.com', NULL, 'SimonaCosta', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore fantasy.'),
('antonio.gallo@example.com', NULL, 'AntonioGallo', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Critico cinema d’autore.'),
('sara.moretti@example.com', NULL, 'SaraMoretti', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Appassionata arte.'),
('paolo.esposito@example.com', NULL, 'PaoloEsposito', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Recensore sport.'),
('francesca.barbieri@example.com', NULL, 'FrancescaBarbieri', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Specializzata narrativa storica.'),
('alessio.martini@example.com', NULL, 'AlessioMartini', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Esperto videogiochi.'),
('marta.romani@example.com', NULL, 'MartaRomani', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Recensore psicologia.'),
('giovanni.borelli@example.com', NULL, 'GiovanniBorelli', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Critico musica classica.'),
('valentina.grassi@example.com', NULL, 'ValentinaGrassi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore tendenze.'),
('carlo.bassi@example.com', NULL, 'CarloBassi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 3, 'Esperto fumetti.'),
('laura.rizzi@example.com', NULL, 'LauraRizzi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Specializzata beauty.'),
('roberto.mariani@example.com', NULL, 'RobertoMariani', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Critico teatrale.'),
('alessandra.milani@example.com', NULL, 'AlessandraMilani', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore libri bambini.'),
('giacomo.giorgi@example.com', NULL, 'GiacomoGiorgi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Appassionato scienza.'),
('livia.trevisan@example.com', NULL, 'LiviaTrevisan', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 3, 'Recensore documentari.'),
('stefano.pini@example.com', NULL, 'StefanoPini', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Esperto fitness.'),
('arianna.betti@example.com', NULL, 'AriannaBetti', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore narrativa rosa.'),
('claudio.vitali@example.com', NULL, 'ClaudioVitali', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Recensore fantasy.'),
('irene.marconi@example.com', NULL, 'IreneMarconi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Critico animazione.'),
('lorenzo.gentili@example.com', NULL, 'LorenzoGentili', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Appassionato pop.'),
('cecilia.mazzoni@example.com', NULL, 'CeciliaMazzoni', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Specializzata poesia.'),
('davide.ferri@example.com', NULL, 'DavideFerri', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore sport.'),
('beatrice.carrara@example.com', NULL, 'BeatriceCarrara', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Appassionata serie TV.'),
('filippo.rinaldi@example.com', NULL, 'FilippoRinaldi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 3, 'Critico letteratura.'),
('matteo.russo@example.com', NULL, 'MatteoRusso', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore avventure grafiche.'),
('veronica.monti@example.com', NULL, 'VeronicaMonti', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Recensore benessere.'),
('franco.mancini@example.com', NULL, 'FrancoMancini', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Critico thriller.'),
('michela.zanetti@example.com', NULL, 'MichelaZanetti', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore narrativa.'),
('fabio.riva@example.com', NULL, 'FabioRiva', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Appassionato cucina.'),
('anna.giacomini@example.com', NULL, 'AnnaGiacomini', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Specializzata saggistica.'),
('margherita.fontana@example.com', NULL, 'MargheritaFontana', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Recensore viaggi.'),
('emanuele.lombardi@example.com', NULL, 'EmanueleLombardi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Critico musica indie.'),
('serena.valli@example.com', NULL, 'SerenaValli', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Recensore scienza.'),
('alberto.villa@example.com', NULL, 'AlbertoVilla', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 3, 'Critico cinema.'),
('lucia.cortesi@example.com', NULL, 'LuciaCortesi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Recensore letteratura.'),
('nicola.marchetti@example.com', NULL, 'NicolaMarchetti', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Specializzato storici.'),
('gabriele.conti@example.com', NULL, 'GabrieleConti', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Appassionato fumetti.'),
('arianna.lombardo@example.com', NULL, 'AriannaLombardo', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 0, 'Recensore young adult.'),
('carla.tosi@example.com', NULL, 'CarlaTosi', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 1, 'Specializzata teatro.'),
('ludovico.romani@example.com', NULL, 'LudovicoRomani', 'c2FsYXRpbm8qLxu4lzt7bsqrJFkeqoCZH1dy3H3eQlX67GQoS2vJUw==', 'RECENSORE', 2, 'Critico fantasy.');
